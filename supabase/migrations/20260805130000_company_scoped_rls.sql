...
-- Production-grade company-scoped RLS policies for salon-management.
-- This migration is intentionally atomic and uses SECURITY DEFINER helper functions.
...
-- Drop previous company-scoped policies.
