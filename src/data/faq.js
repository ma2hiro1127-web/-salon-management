...
export const FAQ_CATEGORIES = [
  ...
  { id: "companyStore", label: "会社・店舗設定", displayOrder: 2 },
...
export const FAQ_ITEMS = [
  ...
  },
  {
    ...
    displayOrder: 2,
    enabled: true,
    question: "閉店した店舗はどうすればいいですか？",
    answer: "すぐに削除せず、まず店舗管理画面から「停止」にしてください。以降利用しないことが確定した場合は、「アーカイブ」に切り替えることもできます。",
    keywords: ["閉店", "店舗停止", "アーカイブ", "廃業"],
  },
  {
    id: "companyStore-3",
    category: "companyStore",
    displayOrder: 3,
    enabled: true,
    question: "店舗を削除するとデータも消えますか？",
    answer: "店舗の完全削除は取り消せない操作です。基本的には「停止」「アーカイブ」を使用し、完全削除が必要な場合はシステム管理者にご相談ください。",
    keywords: ["店舗削除", "データ消去", "完全削除"],
  },
  ...
  },
  {
    ...
    answer: "通常、ユーザーは自分が所属する会社のデータのみ利用できます。加盟店連携が承認されている場合に限り、権限のある管理者が加盟店側のデータを閲覧できることがあります。",
    keywords: ["会社をまたぐ", "他社データ", "company_id", "加盟店"],
  },
  ...
  },
  {
    ...
    answer: "はい。売上だけを確認する使い方も可能です。月間目標は任意項目のため、設定していない場合は達成率などの目標系の表示だけが省略されます。",
  ...
  },
  {
    ...
    answer: "はい。0は「確認した結果0件だった」という入力済みデータとして扱い、空欄（未入力）とは区別されます。",
  ...
  },
  {
    ...
    answer: "いいえ。日締め状態を維持する仕様の項目については、店長以上が編集しても日締め状態は自動的に解除されません。日締めを解除したい場合は「日締めを解除」ボタンで明示的に操作してください。",
  ...
  },
  {
    ...
    answer: "いいえ。日計管理はあくまで総売上の支払方法の内訳を確認するための機能です。既存の総売上・損益・月次集計へは一切加算されません。",
...

  {
    ...
    enabled: true,
    question: "月間目標は必須ですか？",
    answer: "いいえ。必要な項目だけ設定できます。設定していない項目は、ダッシュボード上でも目標系の表示だけが省略されます。",
  ...
  },
  {
    ...
    answer: "はい。日次入力項目の「口コミ数」だけをONにすれば、目標を設定しなくても口コミ数の入力・累計確認が可能です。",
  ...
  },
  {
    ...
    answer: "いいえ。損益管理を行う店舗のみ、必要な項目を入力してください。使わない費用カテゴリは店舗ごとに対象外に設定できます。",
  ...
  },
  {
    ...
    answer: "はい。日次入力の「月別日計を見る」画面にある「CSV出力」から、選択している店舗・年月の日計データを出力できます。",
...

  {
    ...
    answer: "はい。正式契約へ移行した場合も、それまで入力したデータはそのまま引き継がれます。",
  ...
  },
  {
    ...
    answer: "いいえ。契約状態を「停止」にしてもデータは削除されず保持されます。",
  ...
  },
  {
    ...
    answer: "誤操作防止のため、通常の停止とは別に、システム管理者権限で会社データの削除（30日間は復元できる状態）、その後さらに完全削除（元に戻せません）という2段階の操作が必要です。",
...

  {
    ...
    answer: "設定画面で「保存」ボタンを押して保存が完了しているかご確認ください。保存後も表示されない場合は、一度ページを再読み込みしてください。それでも解決しない場合は管理者へご連絡ください。",
  ...
  },
  {
    ...
    answer: "通常の動作ではありません。ページを再読み込みしても発生する場合は、状況をメモのうえ管理者へ報告してください。",
